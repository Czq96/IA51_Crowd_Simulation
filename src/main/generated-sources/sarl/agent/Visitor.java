...
public class Visitor extends BasicPerson {
  ...
  @SyntheticMember
  public Visitor(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public Visitor(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public Visitor(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
