...
public class BasicPerson extends Agent {
  ...
  @SyntheticMember
  public BasicPerson(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public BasicPerson(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public BasicPerson(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
