...
public class Seller extends BasicPerson {
  ...
  @SyntheticMember
  public Seller(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public Seller(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public Seller(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
