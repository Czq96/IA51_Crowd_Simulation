...
public class Vector2f extends Tuple2f<Vector2f> {
  ...
  @SyntheticMember
  @SarlSourceCode("false")
  private static final boolean $DEFAULT_VALUE$NEW_1 = false;
  ...
  @SyntheticMember
  @SarlSourceCode("false")
  private static final boolean $DEFAULT_VALUE$NEW_2 = false;
  ...
  @SyntheticMember
  @SarlSourceCode("false")
  private static final boolean $DEFAULT_VALUE$NEW_3 = false;
  ...
  @SyntheticMember
  @SarlSourceCode("false")
  private static final boolean $DEFAULT_VALUE$NEW_4 = false;
  ...
  @SyntheticMember
  @SarlSourceCode("false")
  private static final boolean $DEFAULT_VALUE$NEW_5 = false;
  ...
  @SyntheticMember
  @SarlSourceCode("false")
  private static final boolean $DEFAULT_VALUE$NEW_6 = false;
  ...
  @SyntheticMember
  @SarlSourceCode("false")
  private static final boolean $DEFAULT_VALUE$NEW_7 = false;
  ...
  @SyntheticMember
  @SarlSourceCode("false")
  private static final boolean $DEFAULT_VALUE$NEW_8 = false;
  ...
  public float angle(final Vector2f v1) {
    float _xblockexpression = (float) 0;
    {
      ...
      double vDot = (_dot / (_length * _length_1));
      if ((vDot < (-1.0))) {
        vDot = (-1.0);
      }
      if ((vDot > 1.0)) {
  ...
  @SyntheticMember
  private static final long serialVersionUID = 14998756852L;
}
