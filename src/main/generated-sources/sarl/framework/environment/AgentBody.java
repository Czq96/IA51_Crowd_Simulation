...
public class AgentBody extends AbstractMobileObject implements Body {
  ...
  public void influenceKinematic(@DefaultValue("framework.environment.AgentBody#INFLUENCEKINEMATIC_0") final Vector2f linearInfluence, @DefaultValue("framework.environment.AgentBody#INFLUENCEKINEMATIC_1") final float angularInfluence) {
    ...
    if ((linearInfluence != null)) {
      ...
      if ((nSpeed > _maxLinearSpeed)) {
        li.setLength(this.getMaxLinearSpeed());
      }
    }
    float _maxAngularSpeed = this.getMaxAngularSpeed();
    float ai = MathUtil.clamp(angularInfluence, (-_maxAngularSpeed), this.getMaxAngularSpeed());
    UUID _iD = this.getID();
  ...
  @SyntheticMember
  @SarlSourceCode("null")
  private static final Vector2f $DEFAULT_VALUE$INFLUENCEKINEMATIC_0 = null;
  ...
  @SyntheticMember
  @SarlSourceCode("0")
  private static final float $DEFAULT_VALUE$INFLUENCEKINEMATIC_1 = 0;
  ...
  public void influenceSteering(@DefaultValue("framework.environment.AgentBody#INFLUENCESTEERING_0") final Vector2f linearInfluence, @DefaultValue("framework.environment.AgentBody#INFLUENCESTEERING_1") final float angularInfluence) {
    ...
    if ((linearInfluence != null)) {
      ...
      if ((nSpeed > _maxLinearAcceleration)) {
        li.setLength(this.getMaxLinearAcceleration());
      }
    }
    float _maxAngularAcceleration = this.getMaxAngularAcceleration();
    float ai = MathUtil.clamp(angularInfluence, (-_maxAngularAcceleration), this.getMaxAngularAcceleration());
    UUID _iD = this.getID();
  ...
  @SyntheticMember
  @SarlSourceCode("null")
  private static final Vector2f $DEFAULT_VALUE$INFLUENCESTEERING_0 = null;
  ...
  @SyntheticMember
  @SarlSourceCode("0")
  private static final float $DEFAULT_VALUE$INFLUENCESTEERING_1 = 0;
  ...
  @SyntheticMember
  private static final long serialVersionUID = 457998078L;
}
